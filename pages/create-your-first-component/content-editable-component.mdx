...
description: We'll delve into the process of making your Sitecore component content-editable in a Next.js environment. This can be achieved by leveraging the SitecoreContext object, which can be accessed using the useSitecoreContext hook.
---
