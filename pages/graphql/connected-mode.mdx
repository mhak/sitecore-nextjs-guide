...
<Callout>
  Knowledge check:  
    ...
    1. Where does the GraphQL data come from the Layout Service in connected mode? If not, where does it come from?
    1. How do you regenerate GraphQL introspection data?
    1. How do you regenerate types?
</Callout>