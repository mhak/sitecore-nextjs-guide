...
## Add rendering
We would like to add the rendering to every page. Typically base page. standard value
1. Navigate to `/sitecore/templates/Project/xmnextjs/App Route/__Standard Values`
