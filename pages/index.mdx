---
title: Introduction
description: Welcome to this beginner's guide to developing with Sitecore Next.js. This guide is designed to be a starting point for developers who are new to building Sitecore solutions in a headless, Next.js environment.
---
# Introduction
 
Welcome to this beginner's guide to developing with Sitecore Next.js. This guide is designed to be a starting point for developers who are new to building Sitecore solutions in a headless,
Next.js environment.
...
It provides step-by-step instructions on setting up a local environment and creating components. While this guide doesn't go into depth on every topic, it is intended to help the audience
