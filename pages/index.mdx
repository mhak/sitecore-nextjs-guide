...
<Head>
    <meta property="og:site_name" content="Sitecore Next.js Guide" />
    ...
    dangerouslySetInnerHTML={{
        ...
        "@type" : "WebSite",
        "name" : "Sitecore Next.js Guide",
        "url" : "https://sitecore-nextjs-guide.hakmeng.com"
        }
        `
    }}
    />
...
1. Create basic components using Next.js
1. GraphQL
    1. An introduction to GraphQL
    1. Understanding the distinction between Integrated and Connected modes
    1. Learning how to construct queries using the xGraph Browser
    1. Building a component that utilizes GraphQL to retrieve multiple Sitecore items in both Integrated and Connected modes
...
If you already have one, feel free to skip to [create your first component](/build/create-your-first-nextjs-component).
