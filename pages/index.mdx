...
1. GraphQL
    1. Brief overview of GraphQL
    1. The difference between Integrated vs Connected mode
    1. Sitecore xGraph Browser
    1. Create a component utilizing GraphQL to pull multiple Sitecore items
        1. Integrated mode
        1. Connected mode
